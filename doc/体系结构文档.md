...
- 处理静态设计模型
  ...
  ![逻辑视图包图](https://seec-pkun.oss-cn-beijing.aliyuncs.com/image/%E9%80%BB%E8%BE%91%E8%A7%86%E5%9B%BE%E5%8C%85%E5%9B%BE.png)
...
- mysql数据库表
  ...
  数据库中包括User表，Coupon表，Hotel表，HotelRoom表，Order表，表中字段与PO类中属性相同，主键已在PO中说明，PO中的String在数据库中统一为varchar(255)，枚举类型统一为varchar(255)
